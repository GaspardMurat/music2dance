...
def ConvLSTM2dModel(input_shape, output_shape, learning_rate):
    ...
    conv_enc1 = TimeDistributed(
        Conv2D(filters=8, kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu'))(conv_enc1)
    ...
    conv_enc2 = TimeDistributed(
        Conv2D(filters=16, kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu'))(conv_enc2)
    conv_enc2_bn = TimeDistributed(BatchNormalization(axis=-1))(conv_enc2)

    conv_enc3 = TimeDistributed(
        Conv2D(filters=32, kernel_size=(3, 3), strides=(2, 2), padding='same', activation='relu'))(conv_enc2_bn)
    conv_enc3 = TimeDistributed(
        Conv2D(filters=32, kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu'))(conv_enc3)
    ...
    conv_mono_dec1 = Conv2D(filters=8, kernel_size=(6, 4), strides=(4, 1), padding='same', activation='relu')(
        decoder_input)
    conv_mono_dec1 = Conv2D(filters=8, kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu')(
        conv_mono_dec1)
    ...
    conv_mono_dec2 = Conv2D(filters=16, kernel_size=(3, 3), strides=(2, 1), padding='same', activation='relu')(
        conv_mono_dec1_bn)
    conv_mono_dec2 = Conv2D(filters=16, kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu')(
        conv_mono_dec2)
    conv__mono_dec2_bn = BatchNormalization(axis=-1)(conv_mono_dec2)

    conv_mono_dec3 = Conv2D(filters=32, kernel_size=(3, 3), strides=(2, 2), padding='same', activation='relu')(
        conv__mono_dec2_bn)
    conv_mono_dec3 = Conv2D(filters=32, kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu')(
        conv_mono_dec3)
    ...
    conv_dec2 = TimeDistributed(
        Conv2DTranspose(filters=16, kernel_size=(3, 3), strides=(2, 1), padding='same', activation='relu'))(
        conv_dec1_bn)
    conv_dec2 = TimeDistributed(
        Conv2DTranspose(filters=16, kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu'))(
        conv_dec2)
    conv_dec2_bn = TimeDistributed(BatchNormalization(axis=-1))(conv_dec2)

    conv_dec3 = TimeDistributed(
        Conv2DTranspose(filters=8, kernel_size=(6, 4), strides=(4, 1), padding='same', activation='relu'))(
        conv_dec2_bn)
    conv_dec3 = TimeDistributed(
        Conv2DTranspose(filters=8, kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu'))(
        conv_dec3)
